		 ...
		 /* pickup address detail*/
		  /*customer  detail*/
		   ...
		   customer_address1 = customer_address.split(',city');
			...
			/* live api */
			/* test api */
			 request.open('POST', 'https://api-staging.sendd.co/core/api/v2/order/international/',true);
			...
			request.setRequestHeader('Content-Type', 'application/json');
			request.setRequestHeader('Authorization', 'Token 97fd62232fa680556005247329f65f5ff0b7eae6');
			/* test api */
				}
